...
class WorkerProcess(multiprocessing.Process):
  def __init__(self, data_id_1,data_id_2,cam_url1,cam_url2,port,pr1_ip,pr1_port,pr2_ip,pr2_port):
    super(WorkerProcess, self).__init__()
    self.data_id_1 = data_id_1
    self.data_id_2 = data_id_2
  ...
  def run(self):
    config_msg = "$add," + self.data_id_1 + "P" + "," +  self.ip_own + "," + str(self.port_recv_p1) + ";"
    ...
    while True:
      ...
      if temp[1] == "T":
        ...
        self.HD = self.HD1 or self.HD2
        #self.HD = True
        reply_msg_1 = "#" + self.data_id_1 + "I" + ","
        reply_msg_2 = "#" + self.data_id_2 + "I" + ","
        if(not self.HD1):
          print self.HD1
          reply_msg_1 += "HND;"

          print self.ip_p2 , self.port_send_p2
          self.sock_send.sendto(reply_msg_1 , (self.ip_p2, self.port_send_p2))
          print reply_msg_1
        ...
        if(not self.HD2):
          ...
          print self.ip_p2 , self.port_send_p2
          self.sock_send.sendto(reply_msg_2 , (self.ip_p2, self.port_send_p2))
          print reply_msg_2
        else:
          print self.HD2
          reply_msg_2 += "HD;"
...
def main(args):
  ...
  with open("server.cfg","r") as inf:
    ...
    for trow in row:
      ...
      if len(trow) == 5:
        data_id_2 = trow[1]
      #if dic[i] != data_id_1 or dic[i] != data_id_2:
       # continue
      cam_url1 = trow[2]
      cam_url2 = ""
      port = trow[3]
      if len(trow) == 5:
        cam_url2 = trow[3]
        port = trow[4]
      pool.append(WorkerProcess(data_id_1,data_id_2,cam_url1,cam_url2,i,pr1_ip,pr1_port,pr2_ip,pr2_port))
      break
    #  i += 1
